defmodule Phoenix.Sync.PlugTest do
  ...
  defmodule MyEnv.TestRouter do
    ...
    get "/shapes/dynamic/:user_id/:age" do
      ...
      Phoenix.Sync.Plug.send_configuration(conn, shape, MyEnv.client!())
    end
  end
  ...
  describe "Plug" do
    test "returns a url and query parameters" do
      resp =
        ...
        |> Phoenix.Sync.Plug.call(%{client: MyEnv.client!()})
